# The following script was obtained from:
# https://github.com/TGuillerme/Total_Evidence_Method-Missing_data/blob/master/Functions/TreeComparisons/bhatt.coef.R
#
##########################
...
#'
#' @return returns Bhattacharyya Coefficient
#'
#' @author Thomas Guillerme \url{https://github.com/TGuillerme/Total_Evidence_Method-Missing_data/blob/master/Functions/TreeComparisons/bhatt.coef.R}
#'
#' @export
#'
#'
